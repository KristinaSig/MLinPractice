...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --tokenize --analyze_sentiment -e data/preprocessing/pipeline.pickle
